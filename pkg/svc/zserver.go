...
//
// TODO: Extend the PortalInfoblox service by defining new RPCs and
...
//
// TODO: Create an implementation of the PortalInfoblox server
...
// implementation of PortalInfoblox server interface service, but only
...
// Default implementation of the PortalInfoblox server interface
type server struct{}
...
func NewBasicServer() (pb.PortalInfobloxServer, error) {
	return &server{}, nil
}
